...
class CalculationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calculation" do
    assert_difference("Calculation.count") do
      post calculations_url, params: { calculation: { notes: @calculation.notes, product: @calculation.product, size: @calculation.size, weight: @calculation.weight } }
    end
  ...
  test "should update calculation" do
    patch calculation_url(@calculation), params: { calculation: { notes: @calculation.notes, product: @calculation.product, size: @calculation.size, weight: @calculation.weight } }
