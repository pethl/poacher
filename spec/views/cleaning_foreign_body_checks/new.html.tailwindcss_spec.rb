...
RSpec.describe "cleaning_foreign_body_checks/new", type: :view do
  before(:each) do
    assign(:cleaning_foreign_body_check, CleaningForeignBodyCheck.new(
      milk_pipeline: false,
      cheese_vat: false,
      used_mill: false,
  ...
  it "renders new cleaning_foreign_body_check form" do
    render

    assert_select "form[action=?][method=?]", cleaning_foreign_body_checks_path, "post" do
