class MakesheetsController < ApplicationController
  ...
  private
    ...
    def makesheet_params
      params.require(:makesheet).permit(
        :status,
        :make_date,
        :make_type,
        :milk_used,
        ...
        :boiler_on_time,
        :steam_hot_water_on_time,
        :cold_milk_in_time,
        :cold_milk_in_state,
        :warm_milk_finish_time,
        :warm_milk_finish_titration,
        ...
        :warm_am,
        :twelve_hr_pm,
        :unusual_smell_appearance,
        :number_of_bottles_from_fm,
        :use_by_date_milk_from_fm,

        :type_of_starter_culture_used,
        :qty_of_starter_used,
        :pre_start_inspection_of_high_risk_items,
        :pre_start_inspection_by_user_id,
        ...
        :slow_cheese,
        :step_1_curd_sample,
        :step_2_record_as_slow,
        :step_3_record_reason,
        :step_4_notify_tim,
        :step_5_apply_label,
        :step_6_record_red_book,
        ...
        :pre_start_inspection_by_2_user_id,
